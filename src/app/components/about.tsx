...
export function About() {
  ...
  return (
    <section ref={aboutRef} id="about" className="space-y-14 px-6">
      <div className="mx-auto flex flex-col items-center space-y-8 md:space-y-14">
        ...
        <div className="flex flex-col items-center space-y-3 md:flex-row md:items-start md:space-y-0 md:space-x-6">
          {/* IMAGE */}
          <div className="shadow-hero flex h-[360px] w-[320px] flex-col items-center space-y-4 rounded-3xl bg-neutral-900/80 p-2 transition duration-300 ease-linear hover:-rotate-6">
